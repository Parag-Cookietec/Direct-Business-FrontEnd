...
@Component({
  selector: 'app-epao-common-workflow-history',
  templateUrl: './epao-common-workflow-history.component.html',
  styleUrls: ['./epao-common-workflow-history.component.css']
})
export class EpaoCommonWorkflowHistoryComponent implements OnInit {
  ...
  constructor(
      ...
      public dialogRef: MatDialogRef<EpaoCommonWorkflowHistoryComponent>,
