...
import { DialogData } from '../../../../models/e-pao/epaoModel';
...
@Component({
  selector: 'app-work-flow-e-pao',
  templateUrl: './work-flow-e-pao.component.html',
  styleUrls: ['./work-flow-e-pao.component.css']
})
export class WorkFlowEPaoComponent implements OnInit {
  ...
  constructor(private elem: ElementRef,
    ...
    public dialogRef: MatDialogRef<WorkFlowEPaoComponent>,
