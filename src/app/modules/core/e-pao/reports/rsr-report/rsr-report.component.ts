...
@Component({
  selector: 'app-rsr-report',
  templateUrl: './rsr-report.component.html',
  styleUrls: ['./rsr-report.component.css']
})
export class RsrReportComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.rsrReportForm = this.rsrReportData();
  }
