...
@Component({
    selector: 'app-crf-year-wise-of-investment',
    templateUrl: './crf-year-wise-of-investment.component.html',
    styleUrls: ['./crf-year-wise-of-investment.component.css']
})
export class CrfYearWiseOfInvestmentComponent implements OnInit {
    CRfyrwiseForm: FormGroup;
    maxDate = new Date();
    todayDate = Date.now();
    ...
    ngOnInit() {
        this.CRfyrwiseForm = this.fb.group({
            loanNo: [''],
            fromDate: [''],
            toDate: [''],
            ammountIn:['']
    ...
    crfyearwisereport(offset = null) {
        const payload = {
            // fromDate: '2020-2021',
            // toDate: '2021-2022',
            fromDate: this.CRfyrwiseForm.value.fromDate,
            toDate: this.CRfyrwiseForm.value.toDate,
            accountTypeId: '1958',
            pageIndex: offset ? offset : this.pageIndex,
            pageSize: this.pageSize
        };
        // const payload = {
            //fromDate: this.crfgrfReportsService.formatDate(this.CRfyrwiseForm.value.fromDate),
        //     toDate: this.crfgrfReportsService.formatDate(this.CRfyrwiseForm.value.toDate),
        //     accountTypeId: '1958',
        //     pageIndex: offset ? offset : this.pageIndex,
        //     pageSize: this.pageSize
        // };
