...
@Component({
  selector: 'app-Scheme-Name-Wise',
  templateUrl: './Scheme-Name-Wise.component.html',
  styleUrls: ['./Scheme-Name-Wise.component.css']
})
export class SchemeNameWiseComponent implements OnInit {

  SchemeNameWiseForm: FormGroup;
  maxDate = new Date();
  todayDate = Date.now();
  ...
  Element_Data: any[] = [
    {
      srno: '28',
      tranche: 'Minor Irrigation Soil Conservation',
  ...
  ngOnInit() {
    this.SchemeNameWiseForm = this.fb.group({
      loanNo: [''],
      fromDate: [''],
      toDate: [''],
    });
