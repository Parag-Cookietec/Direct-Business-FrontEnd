...
@Component({
  selector: 'app-Scheme-wise-GOI-Paid-Report',
  templateUrl: './Scheme-wise-GOI-Paid-Report.component.html',
  styleUrls: ['./Scheme-wise-GOI-Paid-Report.component.css']
})
export class SchemewiseGOIPaidReportComponent implements OnInit {

  SchemewiseGOIPaidReportForm: FormGroup;
  maxDate = new Date();
  todayDate = Date.now();
  ...
  ngOnInit() {
    this.SchemewiseGOIPaidReportForm = this.fb.group({
      loanNo: [''],
      fromDate: [''],
      toDate: [''],
    });
