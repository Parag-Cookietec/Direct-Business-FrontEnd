...
@Component({
  selector: 'app-guarantee-register-guarantee-wise',
  templateUrl: './guarantee-register-guarantee-wise.component.html',
  styleUrls: ['./guarantee-register-guarantee-wise.component.css']
})
export class GuaranteeRegisterGuaranteeWiseComponent implements OnInit {

  GuaranteeRegisterGuaranteeWiseForm: FormGroup;
  maxDate = new Date();
  todayDate = Date.now();
  ...
  ngOnInit() {
    this.GuaranteeRegisterGuaranteeWiseForm = this.fb.group({     
      fromDate: [''],
      toDate: [''],
    });
