...
export class LoanRepaidMonthWiseComponent implements OnInit {
    ...
    getReports(offset = null) {
        const payload = {
            ...
            fromDate: this.nssfLoanRepaidmonthwiseForm.value.fromDate,
            toDate: this.nssfLoanRepaidmonthwiseForm.value.toDate,
        ...
        this.marketLoanReportsService.getMarketLoanRepaidDatewise(payload).subscribe(
            (response: any) => {
                console.log(response);
