...
export class LoanoutstandingMonthWiseComponent implements OnInit {
    ...
    getReport(offset = null) {
        const payload = {
            fromDate: this.nssfLoanoutstandingmonthwiseForm.value.fromDate ? this.nssfLoanoutstandingmonthwiseForm.value.fromDate : "",
            toDate: this.nssfLoanoutstandingmonthwiseForm.value.toDate ? this.nssfLoanoutstandingmonthwiseForm.value.toDate : "",
            yearNo: this.yearID,
        ...
        this.nssfReportsService.getNssfloanoutstandingDateWise(payload).subscribe(
            (response: any) => {
                console.log(response);
