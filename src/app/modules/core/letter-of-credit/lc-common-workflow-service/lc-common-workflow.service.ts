...
getWorkFlowActionV2(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.WORKFLOW_GEN_REQUEST_V2}`, param);
}

getWorkFlowconfigV2(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.WORKFLOW_GEN_REQUEST_ACTION_V2}`, param);
}
/**
