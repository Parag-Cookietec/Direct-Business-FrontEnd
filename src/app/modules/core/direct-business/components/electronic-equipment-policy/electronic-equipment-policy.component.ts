...
@Component({
  selector: 'app-electronic-equipment-policy',
  templateUrl: './electronic-equipment-policy.component.html',
  styleUrls: ['./electronic-equipment-policy.component.css']
})
export class ElectronicEquipmentPolicyComponent implements OnInit {
  isTokentable = false;
