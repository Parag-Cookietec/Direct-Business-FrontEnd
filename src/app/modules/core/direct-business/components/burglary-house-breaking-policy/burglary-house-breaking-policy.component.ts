...
@Component({
  selector: 'app-burglary-house-breaking-policy',
  templateUrl: './burglary-house-breaking-policy.component.html',
  styleUrls: ['./burglary-house-breaking-policy.component.css']
})
export class BurglaryHouseBreakingPolicyComponent implements OnInit {
  isTokentable = false;
