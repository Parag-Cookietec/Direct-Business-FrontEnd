...
export class CommonService implements OnDestroy {
    ...
    loadCommonAttachmentList(param) {
        return this.httpClient.post(`${environment.baseUrl}${APIConst.ATTACHMENT.LOAD_ATTACHMENT_LIST}`, param);
    }

    viewAttachment(params) {
        return this.httpClient.post(`${environment.baseUrl}${APIConst.ATTACHMENT.VIEM_ATTACHMENT}`, params);
    }

    downloadAttachment(params) {
        return this.httpClient.post(`${environment.baseUrl}${APIConst.ATTACHMENT.DOWNLOAD_ATTACHMENT}`, params, {
            responseType: 'blob' as 'json'
        });
    }

    uploadAttachment(params) {
        return this.httpClient.post(`${environment.baseUrl}${APIConst.ATTACHMENT.UPLOAD_ATTACHMENT}`, params);
    }

    getAttachmentTypes(params) {
        return this.httpClient.post(`${environment.baseUrl}${APIConst.ATTACHMENT.ATTACHMENT_TYPE}`, params);
    }
    ...
    getGuaranteeDropdownValues(params, url) {
        return this.httpClient.post(`${environment.baseUrl}${url}`, params);
    }
    saveGuaranteeEntry(params, url) {
        return this.httpClient.post(`${environment.baseUrl}${url}`, params);
    }
}
