...
import { NumbersOnlyDirective, CdkDetailRowDirective, CommonDirective, DecimalLimitTwoOnlyDirective } from './directive/validation.directive';
...
import { ePaoAfterDecimalExtenstionPipe } from './pipes/epao-after-decimal-extenstion.pipe';
...
@NgModule({
    ...
    exports: [
        ...
        ePaoAfterDecimalExtenstionPipe,
